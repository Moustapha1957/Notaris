...
if ($recordn) {
    ...
    if ($montant_remise > 0) {
    	$dernier_montant = $montant_remise;
    }else {
    	$dernier_montant = $montant_initial;
    }
...
'emolument_frais' => $dernier_montant,
...
$cleanednumeronotaris = preg_replace('/[^a-zA-Z0-9]/', '', $numero_notaris);
...
$outputPath = $typeSousDossierPath . 'Emolument_N' . $cleanednumeronotaris . '_' . $cleanedprenom . '_' . $cleanedNom . '.docx';
