    ...
    <div class="content w-full">
        <div class="row align-items-center">
                        ...
                        <div class="col-md-3 d-flex justify-content-md-end">
                            <a href="#addEmployeeModal"  data-toggle="modal" style="color: white;" class="btn btn-primary rounded-pill">Ajouter</a>
...
<?php
    ...
    <center><div id="noResultsMessage" style="display: none; color: red;">Aucun acte trouvé avec cette recherche.</div></center>
    <?php
    }
} else {
?>
